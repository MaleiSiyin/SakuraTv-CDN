...
# CHANGE THESE
auth_email="shenlan2108@gmail.com"  #你的CloudFlare注册账户邮箱,your cloudflare account email address
auth_key="a7e5372229ad0e9aaf096fe2014"   #你的cloudflare账户Globel ID ,your cloudflare Globel ID
zone_name="googlecn.co"   #你的域名,your root domain address
record_name="hi.googlecn.co" #完整域名,your full domain address
